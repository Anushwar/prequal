...
from NN_2 import ANN_128_64_32_16 as LoanApprovalMLP
...
def main():
    ...
    X_train, y_train, X_test, y_test = load_and_prepare_data(train_csv, use_smote=USE_SMOTE)
    
    # Run cross-validation
    print("\nStarting 5-Fold Cross-Validation...")
    cv_scores = train_with_cv(X_train, y_train, X_test, y_test, n_splits=5)
